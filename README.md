...
| **Secure Network Design Lab** | Reconstructed and documented a secure multi-site network design covering VLAN segmentation, IP addressing, RIPv2 routing, SSH configuration and security controls. | Cisco Networking, VLANs, RIPv2, SSH, Network Security | Portfolio reconstruction complete; Packet Tracer validation pending |
